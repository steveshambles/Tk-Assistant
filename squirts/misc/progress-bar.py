...
root = Tk()
root.title('Progress Bar by WAC')
...
def prg_bar():
    ...
    while pro_gress < 101:
        ...
        pro_gress = pro_gress +1
        root.update_idletasks()

prog_bar = Progressbar(root, orient=HORIZONTAL, length=100, mode='determinate')
prog_bar.grid(row=1, column=1)

Button(root, text='Test', bg='skyblue',
